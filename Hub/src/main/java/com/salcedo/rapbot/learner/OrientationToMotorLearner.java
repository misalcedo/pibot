...
public class OrientationToMotorLearner {
    public static void main(final String[] args) throws Exception {
        final SparkContext sparkContext = new SparkContext("local[*]", "OrientationToMotorLearner");
    ...
    private static void runExample(final SQLContext spark) {
        ...
        for (final Row r : predictions.select("id", "text", "probability", "prediction").collectAsList()) {
